...
def segment_images(unet,
    ...
    for image_file_name, bees_positions_list in bees.images_dict.items():
        ...
        unet.segment_fast(image_file_name,
...
def count_bees_on_segmented_images(labelled_validate_db,
    ...
    for image_file_name, bees_positions_list in bees.images_dict.items():
        ...
        count_error_file.write("current image name = {}, count manual = {}, count automatic = {}, current error = {}\n".
    ...
    count_error_file.write("total_error is: {} %\n".format(total_error * numpy.float32(100)))
